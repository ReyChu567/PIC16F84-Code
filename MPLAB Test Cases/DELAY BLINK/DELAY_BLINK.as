...
;; *************** function _main *****************
;; Defined at:
;;		line 8 in file "C:\Users\reyla\OneDrive\Desktop\25 FINALS\3-28-25 FINALS\THESIS MARCH 2025\MPLAB TEST CASES\DELAY BLINK\DELAY_BLINK.c"
...
psect	maintext
psect	maintext
	file	"C:\Users\reyla\OneDrive\Desktop\25 FINALS\3-28-25 FINALS\THESIS MARCH 2025\MPLAB TEST CASES\DELAY BLINK\DELAY_BLINK.c"
	line	8
...
l477:	
;DELAY_BLINK.c: 9: TRISB = 0x00;
	bsf	status, 5	;RP0=1, select bank1
	clrf	(134)^080h	;volatile
	line	10
;DELAY_BLINK.c: 10: PORTB = 0x00;
	bcf	status, 5	;RP0=0, select bank0
	clrf	(6)	;volatile
	goto	l479
	line	12
;DELAY_BLINK.c: 12: while (1) {
	
l9:	
	line	13
	
l479:	
;DELAY_BLINK.c: 13: PORTB = 0x01;
	movlw	(01h)
	bcf	status, 5	;RP0=0, select bank0
	movwf	(6)	;volatile
	line	14
...
l481:	
;DELAY_BLINK.c: 14: _delay((unsigned long)((100)*(1000000/4000.0)));
	opt asmopt_off
movlw	33
movwf	((??_main+0)+0+1),f
	movlw	118
...
opt asmopt_on
	...
	line	16
;DELAY_BLINK.c: 16: PORTB = 0x00;
	bcf	status, 5	;RP0=0, select bank0
	clrf	(6)	;volatile
	line	17
	
l483:	
;DELAY_BLINK.c: 17: _delay((unsigned long)((100)*(1000000/4000.0)));
	opt asmopt_off
movlw	33
movwf	((??_main+0)+0+1),f
	movlw	118
