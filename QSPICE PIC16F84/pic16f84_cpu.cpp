// Automatically generated C++ file on Sat Nov 30 21:06:42 2024
//
// To build with Digital Mars C++ Compiler:
//
//    dmc -mn -WD pic16f84_cpu.cpp Vpic16f84_cpu*.cpp verilated.lib kernel32.lib
//
...
extern "C" __declspec(dllexport) void Destroy(Vpic16f84_cpu *instance)
{
   if(instance)
      delete(instance);
}

extern "C" __declspec(dllexport) void pic16f84_cpu(Vpic16f84_cpu **instance, double t, union uData *data)
{
   if(!*instance)
      *instance = new Vpic16f84_cpu;
